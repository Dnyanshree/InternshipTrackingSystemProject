...
<?php
	...
	$studqry = $db->prepare("select * from student where person_id=?");
	$student_id = $studqry->execute(array($person_id));
                              ...
                              <div class="form">
                                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="" novalidate="novalidate">
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
											<select name="business" class="form-control m-bot15" required="">
											  <?php
												/*-------------------------------Business Listing--------------------------------*/
